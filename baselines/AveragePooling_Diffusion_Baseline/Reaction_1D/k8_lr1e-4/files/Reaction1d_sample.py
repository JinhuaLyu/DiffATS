...
def get_args():
    ...
    p.add_argument('--test_path', type=str,
        default='${DATA_ROOT}/pde_samples/1d_diffusion/pde_samples_10.pt')
    p.add_argument('--ckpt_path', type=str,
        default='${DATA_ROOT}/baseline_checkpoint/average_pooling/Reaction1d_k8_latest.pt')
    p.add_argument('--output_path', type=str,
        default='${DATA_ROOT}/pde_samples_generated/1d_diffusion/AveragePooling/avgpool_reaction1d_generated.pt')
