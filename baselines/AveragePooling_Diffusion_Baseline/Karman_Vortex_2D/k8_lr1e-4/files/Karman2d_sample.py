...
def get_args():
    ...
    p.add_argument('--test_path', type=str,
        default='/anvil/projects/x-eng260004/factor_diffusion/pde_samples/2d_karman/pde_samples_10.pt')
    p.add_argument('--ckpt_path', type=str,
        default='/anvil/projects/x-eng260004/factor_diffusion/baseline_checkpoint/average_pooling/Karman2d_k8_latest.pt')
    p.add_argument('--output_path', type=str,
        default='/anvil/projects/x-eng260004/factor_diffusion/pde_samples_generated/2dkarman/AveragePooling/avgpool_karman2d_generated.pt')
