...
#SBATCH --output=${HOME}/factor_diffusion/1d_physics/1d_burgers/data_generation/logs/gen_%j.out
#SBATCH --error=${HOME}/factor_diffusion/1d_physics/1d_burgers/data_generation/logs/gen_%j.err
