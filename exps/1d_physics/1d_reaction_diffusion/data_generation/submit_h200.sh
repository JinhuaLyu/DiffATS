...
#SBATCH --output=${HOME}/factor_diffusion/1d_physics/1d_reaction_diffusion/data_generation/logs/gen_%j.out
#SBATCH --error=${HOME}/factor_diffusion/1d_physics/1d_reaction_diffusion/data_generation/logs/gen_%j.err

set -euo pipefail
mkdir -p ${HOME}/factor_diffusion/1d_physics/1d_reaction_diffusion/data_generation/logs
...
cd ${HOME}/factor_diffusion/1d_physics/1d_reaction_diffusion/data_generation

OUT_DIR=${DATA_ROOT}/original_data/reaction_1d
mkdir -p "${OUT_DIR}"
