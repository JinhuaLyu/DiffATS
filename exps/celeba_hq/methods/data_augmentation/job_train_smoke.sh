...
#SBATCH --output=${DATA_ROOT}/ablation_results/data_augmentation/logs/smoke_%j.out
#SBATCH --error=${DATA_ROOT}/ablation_results/data_augmentation/logs/smoke_%j.err
