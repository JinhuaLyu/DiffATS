...
#SBATCH --output=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/data_augmentation/logs/full_%j.out
#SBATCH --error=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/data_augmentation/logs/full_%j.err
...
LATEST_CKPT=""
EXP_DIR=$(ls -d /anvil/projects/x-eng260004/factor_diffusion/ablation_results/data_augmentation/[0-9]*-JointDiT 2>/dev/null | sort | tail -1 || true)
