...
#SBATCH --output=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/no_alignment/logs/smoke_%j.out
#SBATCH --error=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/no_alignment/logs/smoke_%j.err
