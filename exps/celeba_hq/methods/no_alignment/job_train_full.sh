...
#SBATCH --output=${DATA_ROOT}/ablation_results/no_alignment/logs/full_%j.out
#SBATCH --error=${DATA_ROOT}/ablation_results/no_alignment/logs/full_%j.err
...
LATEST_CKPT=""
EXP_DIR=$(ls -d ${DATA_ROOT}/ablation_results/no_alignment/[0-9]*-JointDiT 2>/dev/null | sort | tail -1 || true)
