...
#SBATCH --output=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/our_method/logs/sample_%j.out
#SBATCH --error=/anvil/projects/x-eng260004/factor_diffusion/ablation_results/our_method/logs/sample_%j.err
...
mkdir -p /anvil/projects/x-eng260004/factor_diffusion/ablation_results/our_method/samples/{images,latents}
