...
#SBATCH --gres=gpu:1
#SBATCH -t 1:00:00
#SBATCH -o /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d/logs/gen_%j.out
#SBATCH -e /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d/logs/gen_%j.err
