...
#SBATCH --gres=gpu:1
#SBATCH -t 1:30:00
#SBATCH -o /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d_lr_sweep/lr_5e-4/logs/gen_%j.out
#SBATCH -e /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d_lr_sweep/lr_5e-4/logs/gen_%j.err
...
python -u gen_burgers_2d.py \
    --ckpt /anvil/projects/x-eng260004/factor_diffusion/our_method_results/burgers_2d_lr_sweep/lr_5e-4/checkpoints/epoch00500_step0156000.pt \
    --output_dir $OUTDIR \
    --batch_size 50 \
    --seeds 0 1 2 3 4 \
    --sample_steps 250 \
