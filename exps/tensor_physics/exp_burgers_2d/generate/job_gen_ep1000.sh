...
#SBATCH --gres=gpu:1
#SBATCH -t 1:30:00
#SBATCH -o /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d/logs/gen_ep1000_%j.out
#SBATCH -e /anvil/projects/x-eng260004/factor_diffusion/our_method_generation/burgers_2d/logs/gen_ep1000_%j.err
...
python -u reconstruct_gen.py --exp burgers --seed 0 --epoch 1000
