...
#SBATCH --mem=32G
#SBATCH -t 1:00:00
#SBATCH -o ${DATA_ROOT}/our_method_generation/burgers_2d_lr_sweep/lr_5e-4/logs/recon_%j.out
#SBATCH -e ${DATA_ROOT}/our_method_generation/burgers_2d_lr_sweep/lr_5e-4/logs/recon_%j.err
