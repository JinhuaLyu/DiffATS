...
#SBATCH --gres=gpu:1
#SBATCH -t 05:00:00
#SBATCH -o /anvil/projects/x-eng260004/factor_diffusion/our_method_results/burgers_2d_lr_sweep/logs/lr1e-3_%j.out
#SBATCH -e /anvil/projects/x-eng260004/factor_diffusion/our_method_results/burgers_2d_lr_sweep/logs/lr1e-3_%j.err
...
python -u train_burgers_2d.py \
    ...
    --lr 1e-3 \
    --n_epochs 500 \
    --outdir /anvil/projects/x-eng260004/factor_diffusion/our_method_results/burgers_2d_lr_sweep/lr_1e-3 \
