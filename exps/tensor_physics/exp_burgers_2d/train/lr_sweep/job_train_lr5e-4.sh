...
#SBATCH --gres=gpu:1
#SBATCH -t 05:00:00
#SBATCH -o ${DATA_ROOT}/our_method_results/burgers_2d_lr_sweep/logs/lr5e-4_%j.out
#SBATCH -e ${DATA_ROOT}/our_method_results/burgers_2d_lr_sweep/logs/lr5e-4_%j.err
...
python -u train_burgers_2d.py \
    ...
    --lr 5e-4 \
    --n_epochs 500 \
    --outdir ${DATA_ROOT}/our_method_results/burgers_2d_lr_sweep/lr_5e-4 \
