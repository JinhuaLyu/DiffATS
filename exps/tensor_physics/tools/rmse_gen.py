...
def load_gt_factors(exp):
    if exp == 'karman':
        ...
        train = DS('${DATA_ROOT}/tucker_factors/karman_vortex_2d/tucker_karman_rT10_rX128_rY30', split='all', device='cpu')
        test  = DS('${DATA_ROOT}/tucker_factors/karman_vortex_2d/tucker_karman_rT10_rX128_rY30/test_data', split='all', device='cpu', external_stats=train.stats)
    ...
    train = DS('${DATA_ROOT}/tucker_factors/burgers_2d/tucker_burgers_rT5_rH20_rW20', split='all', device='cpu')
    test  = DS('${DATA_ROOT}/tucker_factors/burgers_2d/tucker_burgers_rT5_rH20_rW20/test_data', split='all', device='cpu', external_stats=train.stats)
