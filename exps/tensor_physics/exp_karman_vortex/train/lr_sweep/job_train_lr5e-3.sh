...
#SBATCH --gres=gpu:1
#SBATCH -t 10:00:00
#SBATCH -o ${DATA_ROOT}/our_method_results/karman_vortex_2d_lr_sweep/logs/lr5e-3_%j.out
#SBATCH -e ${DATA_ROOT}/our_method_results/karman_vortex_2d_lr_sweep/logs/lr5e-3_%j.err
...
python -u train_karman_2d.py \
    ...
    --lr 5e-3 \
    --n_epochs 500 \
    --outdir ${DATA_ROOT}/our_method_results/karman_vortex_2d_lr_sweep/lr_5e-3 \
